import type { CoordFrame, TransformSnapshot, Vec3, PossessionMode } from "../net/protocol";
import { framesEqual, vec3Dist, vec3Len } from "../net/protocol";
import type { PlayerRole } from "./events";
